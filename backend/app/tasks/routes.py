...
ChatGPT said:
Here is your fully updated and corrected version of the /api/tasks/complete route with the following fixes:

✅ Fixes included:
last_activity_date is always updated correctly

Handles conversion from date to datetime

progress is now correctly synced with streak for streak-based challenges

Clean and readable with comments
